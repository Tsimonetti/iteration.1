#I’m writing a Python program to help my friend track the amount of energy
# drinks he drinks in a year. Keep the code simple and easy to use for most
# people. You should be able to input how many energy drinks they drank on
# which specific months of the year, and the output should tell them possible
# health effects that amount of caffeine could cause. Then it should graph the
# results on a chart where the x-axis is the months and the y-axis is the
# amount of energy drinks. It should also have text at the end recommending
# the number of energy drinks a person should drink in a year. Please return
...
def main():
    ...
    print(f"\nTotal caffeine intake for the year: {total_caffeine} mg")
